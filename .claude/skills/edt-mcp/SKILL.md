...
## Что НЕ работает / не покрыто (по состоянию на v1.22.0)

Сверено с кодом main v1.22.0 (2026-08-14). Часть граблей прошлых редакций **закрыта** — см. «Починено в v1.18.0–v1.22.0» ниже, не воспроизводи старые workaround'ы. Оставшиеся пункты — ограничения платформы 1С/EDT, кодом плагина не закрываются.
