...
- Иконка статус-бара `MCP: stopped` не появлялась в правом нижнем углу EDT после установки (lazy-bundle не активировался до сборки трима). Добавлен `IStartup` для force-активации UI-плагина при старте workbench.
