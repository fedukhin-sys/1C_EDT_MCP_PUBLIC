...
public class PrivacyRedactorTest {
    ...
    @Test public void masksVariableOfSensitiveRefType() {
        ...
        Object out = redactor(cat).redact("get_variables", Map.of(), vars);
    ...
    @Test public void masksVariableByAttributeName() {
        ...
        Object out = redactor(PiiCatalog.builder().build()).redact("get_variables", Map.of(), vars);
    ...
    @Test public void eventLogUserAlwaysPseudonymised() {
        ...
        Object out = redactor(PiiCatalog.builder().build()).redact("query_event_log", Map.of("name","Demo"), result);
    ...
    @Test public void skipsWhenInfobaseFlaggedNoPii() {
        ...
        Map<String,Object> result = new LinkedHashMap<>();
        result.put("events", new ArrayList<>(List.of(ev)));
        Object out = r.redact("query_event_log", Map.of("name","TestBase"), result);
    ...
    @Test public void masksEvaluateErrorViaRegex() {
        ...
        Object out = redactor(PiiCatalog.builder().build()).redact("evaluate", Map.of(), res);
